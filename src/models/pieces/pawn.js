...
class Pawn extends Piece {
    ...
    getPossibleMoves(opponentPieces, playerPieces) {
        ...
        if (this.cellStatus(x, y + direction, opponentPieces, playerPieces) === Constants.CELL_STATUS_EMPTY) {
        ...
        if (this.cellStatus(x - 1, y + direction, opponentPieces, playerPieces) === Constants.CELL_STATUS_OCCUPIED_OPPONENT) {
